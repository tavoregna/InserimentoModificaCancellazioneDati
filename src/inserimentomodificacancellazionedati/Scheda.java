...
public class Scheda extends javax.swing.JFrame {
    ...
    public Scheda(MenuPrincipale p) {
        initComponents();
        parent=p;
        
        pannello.setLayout(new BoxLayout(pannello, BoxLayout.Y_AXIS));
        pannello.add(new ElementoScheda(this));
        pannello.add(new ElementoScheda(this));
        pannello.add(new ElementoScheda(this));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Scheda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Scheda(null).setVisible(true);
            }
        });
    }
